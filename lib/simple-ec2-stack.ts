...
export class SimpleEc2Stack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    // example resource
    // const queue = new sqs.Queue(this, 'SimpleEc2Queue', {
    ...
    // Let's create a role for the instance
    ...
    // let's use the security group to allow inbound traffic on specific ports
